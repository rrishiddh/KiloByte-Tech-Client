...
const RecentBlogPost = () => {
  ...
  return (
    <div className="my-10 w-[90%] mx-auto">
      <h1 className="text-center text-2xl max-md:text-xl font-bold my-6 mx-auto w-[80%]">
        {" "}
        Checkout Some <br className="md:hidden" />{" "}
        <Typewriter
          words={[
            "Recent Blog Post!",
            "Thoughts Shared With Us!",
            "New Tech Recent Released!",
          ]}
          loop={0}
          cursor
          cursorBlinking
          ...
          >
            <div className="card-body">
              ...
              <p className="text-sm font-light">
                {" "}
                {blog.shortDescription.substring(0, 30) + "..."}
              </p>
